...
export const KelickHomeIcon = (props: SVGProps<SVGSVGElement>) => (
...
export const KelickOrgIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M7 9.00258L7.01 8.99147" stroke="#2E3333" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M7 13.0026L7.01 12.9915" stroke="#2E3333" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M7 17.0026L7.01 16.9915" stroke="#2E3333" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <path
...
export const KelickUsersIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickSendCashIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickCalendarIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M7 1.99258V5.99258" stroke="#2E3333" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <path
...
export const KelickReceiveCashIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="M10 8.22335C9.20085 7.48567 7.79346 6.97257 6.5 6.94044M3 15.2234C3.75189 16.1488 5.1499 16.6766 6.5 16.7214M6.5 6.94044C4.96102 6.90221 3.58333 7.54487 3.58333 9.30028C3.58333 12.531 10 10.9157 10 14.1464C10 15.9891 8.2922 16.7808 6.5 16.7214M6.5 6.94044V4.99258M6.5 16.7214V18.9926"
      stroke="#2E3333"
...
export const KelickMoreIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickWalletIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickBulkUploadIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickAddUserIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const KelickCircleCheckIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M7 12.5L10 15.5L17 8.5" stroke="#2E3333" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <path
